...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { name: @tree.name, style: @tree.style, twitter: @tree.twitter, user_id: @tree.user_id, youtube: @tree.youtube } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { name: @tree.name, style: @tree.style, twitter: @tree.twitter, user_id: @tree.user_id, youtube: @tree.youtube } }
